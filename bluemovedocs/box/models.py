...
class Doc(models.Model):
    ...
    outside_permission_id = models.CharField(max_length = 300, null=True)
    permission_id = models.CharField(max_length = 300, null=True)
    inside_permission_id = models.CharField(max_length = 300, null=True)
    creation_datetime = models.CharField(max_length = 100)
    submission_datetime = models.CharField(max_length = 100)
    submit_flag = models.BooleanField(default = False)
    return_datetime = models.CharField(max_length = 100)
