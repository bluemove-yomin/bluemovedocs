...
def gmailTest():
    ...
    SERVICE_ACCOUNT_SCOPES = ['https://www.googleapis.com/auth/gmail.send']
    ...
    credentials_delegated = credentials.with_subject("tejava@bluemove.or.kr")
    mail_service = build('gmail', 'v1', credentials = credentials_delegated)
    # mail_service = build('gmail', 'v1', credentials = credentials)
    ...
    # 03. 메일 전송
    user_id = 'management@bluemove.or.kr'
    message = (
